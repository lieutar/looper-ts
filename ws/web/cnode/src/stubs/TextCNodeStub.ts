import { TextCNode, type TextCNodeDSLOptType, type TextCNodeStubParamsType } from "../components";
...
export class TextCNodeStub extends AbstractComponentStub{
  ...
  forceBuild(){
    const man = CNodeManager.getCurrentManager();
    return this.build(man, this.makeElement(man)); }
