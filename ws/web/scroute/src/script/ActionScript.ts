...
import { AbstractHandlerScript, type AbstractHandlerScriptParams }from './AbstractHandlerScript';
 ...
 */
export interface ActionScriptParams extends AbstractHandlerScriptParams{}
export class ActionScript extends AbstractHandlerScript {
  execute(_context: IScriptChainContext): Promise<IActionResult>{ throw new Error(); } }
...
export class NullActionScript extends ActionScript {
  ...
  override async execute(_: IScriptChainContext){ return NullIActionResult; }
